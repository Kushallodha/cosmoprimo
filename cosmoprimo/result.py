...
def DESIDR2Flatw0waCDM(engine='class', precision=None, extra_params=None, **params):
    """
    Initialize :class:`Cosmology` with the best fit values for a flat, w0wa, CDM cosmology
    from CMB + DESI BAO DR2 + DESY5 (https://arxiv.org/pdf/2503.14738).

    The best fit values are from:
    '/global/cfs/cdirs/desicollab/science/cpe/y3_bao_cosmo/bao_v1p2/bao/iminuit/camb/run1/base_w_wa/
    desi-bao-all_desy5sn_planck2018-lowl-TT-clik_planck2018-lowl-EE-clik_planck-NPIPE-highl-CamSpec-
    TTTEEE_planck-act-dr6-lensing'
    ...
    precision : string, default=None
        Precision for computation; pass 'base' to get same precision as AbacusSummitBase
        (few minutes).
